if(isServer) then {
	...
	[[
		...
		[(_position select 0) - 30, (_position select 1) - 30, 0],
		[(_position select 0) - 30, (_position select 1) + 30, 0]
	],"I_HMG_01_high_weapon_F","Hard","bandit","bandit",0,2,"Random","Random",_mission] call spawn_static;
	...
	_complete = [
		...
		"Bandits have captured a lot of sniper rifles from the Takistani bandit clan, make your move as a bandit whilst they are planning a getaway",		// mission announcement
