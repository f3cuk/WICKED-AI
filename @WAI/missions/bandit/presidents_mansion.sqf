if(isServer) then {
	...
	_crate 			= createVehicle ["box_ind_ammoveh_f",[(_position select 0),(_position select 1),.1], [], 0, "CAN_COLLIDE"];
	
	//Hotel
	_baserunover 	= createVehicle ["Land_BagBunker_Large_F",[(_position select 0),(_position select 1),0],[],0,"CAN_COLLIDE"];
	...
	//Heli Paradrop
	[[(_position select 0),(_position select 1),0],[0,0,0],800,"B_Heli_Attack_01_F",6,"Random","Random",4,"Random","bandit","Random","bandit",false,_mission] spawn heli_para;
	[[(_position select 0) + 50,(_position select 1),0],[50,50,0],800,"B_Heli_Attack_01_F",6,"Random","Random",4,"Random","bandit","Random","bandit",false,_mission] spawn heli_para;
	[[(_position select 0) + 100,(_position select 1),0],[100,0,0],800,"B_Heli_Attack_01_F",6,"Random","Random",4,"Random","bandit","Random","bandit",false,_mission] spawn heli_para;
	...
	],"I_HMG_01_high_weapon_F","Extreme","bandit","bandit",1,2,"Random","Random",_mission] call spawn_static;
