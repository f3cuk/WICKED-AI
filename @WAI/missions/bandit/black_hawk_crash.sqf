if(isServer) then {
	...
	diag_log 		format["WAI: [Mission:[Bandit] Attack Heli Crash]: Starting... %1",_position];
	...
	[[
		...
		[(_position select 0) - 25, (_position select 1) - 25, 0]
	],"I_HMG_01_high_weapon_F","Easy","bandit","bandit",0,2,"Random","Random",_mission] call spawn_static;
	...
	_complete = [
		...
		"A Black Hawk carrying supplies has crashed and bandites are securing the site! Check your map for the location!",	// mission announcement
