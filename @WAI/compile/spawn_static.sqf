if (isServer) then {
...

	{
		...
		_static setVariable["LASTLOGOUT_EPOCH",99999999];
		...
		//PVDZE_serverObjectMonitor set [count PVDZE_serverObjectMonitor,_static];	//PVDZE will need changed to be compatible with A3 Epoch and avoid server cleanup of units
