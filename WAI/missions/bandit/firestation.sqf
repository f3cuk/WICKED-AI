private ["_rndnum","_mission","_position","_loot1","_loot2","_vehclass"];
...
diag_log format["WAI: [Mission:[Bandit] Fire Station]: Starting... %1",_position];
...
//Troops
[_position,5,"Extreme",["Random","AT"],4,"Random","Hero","Random","Hero",_mission] call spawn_group;
[_position,5,"Extreme","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
[_position,5,"Extreme","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
[_position,5,"Extreme","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
_rndnum = ceil (random 5);
[_position,_rndnum,"Extreme","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
_rndnum = ceil (random 5);
[_position,_rndnum,"Extreme","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
...
[
	...
	"STR_CL_BANDIT_FIRESTATION_ANNOUNCE", // mission announcement
	"STR_CL_BANDIT_FIRESTATION_WIN", // mission success
	"STR_CL_BANDIT_FIRESTATION_FAIL" // mission fail
