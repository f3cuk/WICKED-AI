...
[[(_position select 0) - 33,(_position select 1) - 18,0],5,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
[[(_position select 0) + 1,(_position select 1) + 29,0],_rndnum,"Hard","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
[[(_position select 0) + 33,(_position select 1) - 7,0],5,"Hard","Random",4,"Random","RU_Doctor","Random",["Hero",100],_mission] call spawn_group;
...
[
	...
	"STR_BANDIT_MV22_ANNOUNCE", // mission announcement
	"STR_BANDIT_MV22_WIN", // mission success
	"STR_BANDIT_MV22_FAIL", // mission fail
