if(isServer) then {
	...
	//Base
	_baserunover 	= createVehicle ["Land_Wreck_Ural_F",[(_position select 0),(_position select 1),0],[],14,"FORM"];
	...
	_complete = [
		...
		"bandites are defending a broken down Ural! Check your map for the location!",	// mission announcement
