if(isServer) then {
	...
	_complete = [
		...
		"Success!  Bandits have secured the snipers and taken the chopper!",		// mission success
		"Mission Fail!  Bandits did not secure the sniper rifles in time"				// mission fail
