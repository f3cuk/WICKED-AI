if(isServer) then {
	...
	_crate 			= createVehicle ["Cargo_Container",[(_position select 0),(_position select 1),.1], [], 0, "CAN_COLLIDE"];
	
	//Hotel
	_baserunover 	= createVehicle ["Land_i_Barracks_V2_F",[(_position select 0),(_position select 1),0],[],0,"CAN_COLLIDE"];
	...
	//Heli Paradrop
	[[(_position select 0),(_position select 1),0],[0,0,0],800,"B_Heli_Attack_01_F",6,"Random","Random",4,"Random","Hero","Random","Hero",false,_mission] spawn heli_para;
	[[(_position select 0) + 50,(_position select 1),0],[50,50,0],800,"B_Heli_Attack_01_F",6,"Random","Random",4,"Random","Hero","Random","Hero",false,_mission] spawn heli_para;
	[[(_position select 0) + 100,(_position select 1),0],[100,0,0],800,"B_Heli_Attack_01_F",6,"Random","Random",4,"Random","Hero","Random","Hero",false,_mission] spawn heli_para;
	...
	],"O_HMG_01_support_high_F","Extreme","Hero","Hero",1,2,"Random","Random",_mission] call spawn_static;
	...
	_complete = [
		...
		"The President is in town for a press conference, rumour has it bandits are planning his assassination",	// mission announcement
