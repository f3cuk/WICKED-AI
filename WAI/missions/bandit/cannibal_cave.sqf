...
[[(_position select 0) + 12, (_position select 1) + 42.5, .01],5,"extreme",["random","AT"],4,"random","Hero","random","Hero",_mission] call spawn_group;
[[(_position select 0) + 11, (_position select 1) + 41, .01],5,"hard","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
[[(_position select 0) - 12, (_position select 1) - 43, .01],5,"random","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
_rndnum = ceil (random 5);
[[(_position select 0) - 13, (_position select 1) - 43, .01],_rndnum,"random","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
_rndnum = ceil (random 5);
[[(_position select 0) - 20, (_position select 1) - 43, .01],_rndnum,"random","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
