...
[
	...
	"A Hero Squad has started an outpost", // mission announcement
	"Bandits have secured the outpost!", // mission success
	"Bandits did not secure the outpost", // mission fail
