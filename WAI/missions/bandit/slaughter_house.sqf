...
[
	...
	"STR_CL_BANDIT_SLAUGHTERHOUSE_ANNOUNCE", // mission announcement
	"STR_CL_BANDIT_SLAUGHTERHOUSE_WIN", // mission success
	"STR_CL_BANDIT_SLAUGHTERHOUSE_FAIL", // mission fail
