...
diag_log format["WAI: [Mission:[Bandit] Farmer]: Starting... %1",_position];
...
[[(_position select 0) -17,(_position select 1) +29,0],5,"Easy",["Random","AT"],4,"Random","RU_Villager2","Random","Hero",_mission] call spawn_group;
[[(_position select 0) -12,(_position select 1) +20,0],_rndnum,"Random","Random",4,"Random","Citizen2_EP1","Random","Hero",_mission] call spawn_group;
...
[
	...
	"A farmer is selling supplies at his farm", // mission announcement
	"Bandits have killed the farmer's workers", // mission success
	"The farmer has sold all of his supplies", // mission fail
