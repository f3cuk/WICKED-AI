...
[[(_position select 0) + 9, (_position select 1) - 13, 0],5,"Hard",["Random","AT"],4,"Random","Rocker3_DZ","Random","Hero",_mission] call spawn_group;
[[(_position select 0) + 13, (_position select 1) + 15, 0],5,"Hard","Random",4,"Random","Rocker1_DZ","Random","Hero",_mission] call spawn_group;
[[(_position select 0) - 13, (_position select 1) + 15, 0],5,"Hard","Random",4,"Random","Policeman","Random","Hero",_mission] call spawn_group;
[[_position select 0, _position select 1, 0],_rndnum,"Hard","Random",4,"Random","Policeman","Random","Hero",_mission] call spawn_group;
...
//Heli Paradrop
[[(_position select 0), (_position select 1), 0],200,"UH1H_DZ","East",[3000,4000],150,1.0,200,10,"Hard","Random",4,"Random","Hero","Random","Hero",true,_mission] spawn heli_para;
...
[
	...
	"STR_CL_BANDIT_CROPRAIDER_ANNOUNCE", // mission announcement
	"STR_CL_BANDIT_CROPRAIDER_WIN", // mission success
	"STR_CL_BANDIT_CROPRAIDER_FAIL", // mission fail
