...
[
	...
	[], // cleanup objects
	"STR_BANDIT_ARMEDVEHICLE_ANNOUNCE", // mission announcement
	"STR_BANDIT_ARMEDVEHICLE_WIN", // mission success
	"STR_BANDIT_ARMEDVEHICLE_FAIL", // mission fail
	[0,0,[25,crate_items_chainbullets],0,2] // Dynamic crate array
