...
//Heli Paradrop
[[(_position select 0), (_position select 1), 0],[0,0,0],400,"UH1H_DZ",10,1,"Random",4,"Random","USMC_LHD_Crew_Blue","Random",False] spawn heli_para;
...
if (_playerPresent) then {
	...
	diag_log format["WAI: Mission Base Bandits at %1 ended",_position];
