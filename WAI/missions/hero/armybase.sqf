...
[[(_position select 0) - 12, (_position select 1) + 2, 0],5,"Hard",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 2, (_position select 1) + 2, 0],5,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 14, (_position select 1) - 35, 0],5,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 13, (_position select 1) + 35, 0],_rndnum,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
...
[
	...
	"STR_CL_HERO_ARMYBASE_ANNOUNCE", // mission announcement
	"STR_CL_HERO_ARMYBASE_WIN", // mission success
	"STR_CL_HERO_ARMYBASE_FAIL", // mission fail
