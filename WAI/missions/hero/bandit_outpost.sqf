...
[[(_position select 0) + 2,_position select 1,0],5,"Easy",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) - 2,_position select 1,0],_rndnum,"Easy","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
...
[
	...
	"Easy", // Difficulty
	"Bandit Outpost", // Name of Mission
	...
	"A Bandit Squad has started an outpost", // mission announcement
	"Survivors have secured the outpost!", // mission success
	"Survivors did not secure the outpost", // mission fail
