private ["_rndnum","_room","_mayor_himself","_mission","_position","_mansion","_mayor"];
...
// Loot
_loot = [10,5,[5,crate_items_high_value],3,[2,crate_backpacks_large]];
...
//Heli Paradrop
[_position,400,"UH60M_EP1_DZE","North",[3000,4000],150,1.0,100,10,"Random","Random",4,"Random","Bandit","Random","Bandit",false,_mission] spawn heli_para;
