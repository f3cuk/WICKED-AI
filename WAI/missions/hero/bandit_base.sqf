...
[
	...
	"STR_HERO_BANDITBASE_ANNOUNCE", // mission announcement
	"STR_HERO_BANDITBASE_WIN", // mission success
	"STR_HERO_BANDITBASE_FAIL", // mission fail
