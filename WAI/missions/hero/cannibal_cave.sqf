...
[[(_position select 0) + 12, (_position select 1) + 42.5, 0],5,"extreme",["random","at"],4,"random","bandit","random",["bandit",150],_mission] call spawn_group;
[[(_position select 0) + 11, (_position select 1) + 41, 0],5,"hard","random",4,"random","bandit","random","bandit",_mission] call spawn_group;
[[(_position select 0) - 12, (_position select 1) - 43, 0],5,"random","random",4,"random","bandit","random","bandit",_mission] call spawn_group;
[[(_position select 0) - 13, (_position select 1) - 43, 0],_rndnum,"random","random",4,"random","bandit","random","bandit",_mission] call spawn_group;
...
[
	...
	"STR_CL_GENERAL_CANNIBAL_ANNOUNCE", // mission announcement
	"STR_CL_GENERAL_CANNIBAL_WIN", // mission success
	"STR_CL_GENERAL_CANNIBAL_FAIL", // mission fail
	[10,8,[2,crate_items_high_value],3,[4,crate_backpacks_large]] // Dynamic crate array
