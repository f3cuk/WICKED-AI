...
// Loot
_loot = [10,8,[2,crate_items_high_value],3,[2,crate_backpacks_large]];
...
//Troops
[[(_position select 0) + 12, (_position select 1) + 42.5, .01],5,"extreme",["random","at"],4,"random","bandit","random",["bandit",150],_mission] call spawn_group;
[[(_position select 0) + 11, (_position select 1) + 41, .01],5,"hard","random",4,"random","bandit","random","bandit",_mission] call spawn_group;
[[(_position select 0) - 12, (_position select 1) - 43, .01],5,"random","random",4,"random","bandit","random","bandit",_mission] call spawn_group;
_rndnum = ceil (random 5);
[[(_position select 0) - 13, (_position select 1) - 43, .01],_rndnum,"random","random",4,"random","bandit","random","bandit",_mission] call spawn_group;
_rndnum = ceil (random 5);
[[(_position select 0) - 20, (_position select 1) - 43, .01],_rndnum,"random","random",4,"random","bandit","random","bandit",_mission] call spawn_group;
