if(isServer) then {
	...
	//Heli Para Drop
	[[(_position select 0),(_position select 1),0],[0,0,0],400,"I_Heli_Transport_02_EPOCH",10,"Random","Random",4,"Random","Bandit","Random","Bandit",false,_mission] spawn heli_para;
