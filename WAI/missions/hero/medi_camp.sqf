if(isServer) then {
	...
	//Medical Supply Camp
	_baserunover1 	= createVehicle ["Land_Research_HQ_F",[(_position select 0) +15, (_position select 1) -20,0],[], 0, "CAN_COLLIDE"];
	_baserunover2 	= createVehicle ["Land_Cargo_HQ_V1_F",[(_position select 0) +25, (_position select 1) +10,0],[], 0, "CAN_COLLIDE"];
