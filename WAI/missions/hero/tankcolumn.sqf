private ["_rndnum","_directions","_crate_type","_mission","_position","_crate","_baserunover","_baserunover1","_baserunover2","_baserunover3","_baserunover4","_baserunover5","_baserunover6","_baserunover7","_baserunover8","_baserunover9","_baserunover10","_baserunover11","_baserunover12","_baserunover13"];
...
_baserunover = [_baserunover2,_baserunover3,_baserunover4,_baserunover5,_baserunover6,_baserunover7,_baserunover8,_baserunover9,_baserunover10,_baserunover11,_baserunover12,_baserunover13];

//_directions = [0,91.28,92.01,108.4,112.3,0,0,90.007,0,0,0,0,0];
_directions = [91.28,92.01,108.4,112.3,0,0,90.007,0,0,0,0,0];
...
[[(_position select 0) - 7, (_position select 1) - 10, 0],5,"Hard",["Random","AT"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 16, (_position select 1) - 5, 0],5,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 4, (_position select 1) + 18, 0],5,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) + 4, (_position select 1) + 18, 0],_rndnum,"Hard","Random",4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
...
[
	...
	"STR_CL_HERO_TANK_ANNOUNCE", // mission announcement
	"STR_CL_HERO_TANK_WIN", // mission success
	"STR_CL_HERO_TANK_FAIL", // mission fail
