...
//Troops
[_position,5,"Medium",["Random","AT"],3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
...
//Static Guns
[[[(_position select 0),(_position select 1) + 10, 0]],"Random","Medium","Bandit","Bandit",0,2,"Random","Random",_mission] call spawn_static;
