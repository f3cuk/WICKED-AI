if(isServer) then {
	...
	[[_position select 0, _position select 1, 0],3,"Random","Random",4,"Random","Random","Random","Bandit",true] call spawn_group;
	[[_position select 0, _position select 1, 0],3,"Random","Random",4,"Random","Random","Random","Bandit",true] call spawn_group;
	...
	[_position,"Medium","Black Hawk Crash","Bandit"] execVM wai_marker;
