...
ai_killfeedTimer 	 = 5; 			// Time in seconds for the message to disappear 
...
wai_mission_timer		= [1,2]; 			// time between missions. Default: 5-15 minutes
wai_mission_timeout		= [5,10]; 			// time each mission takes to timeout if inactive. Default: 15-30 minutes
...
wai_crates_smoke_color  = "smokeShellGreen"; 	// Options: "SmokeShellRed", "SmokeShellGreen", "SmokeShellYellow", "SmokeShellPurple", "SmokeShellBlue" and "SmokeShellOrange"
