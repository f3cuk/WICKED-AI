...
"GUE_Soldier_MG_DZ",				          //Skin "" for random or classname here.
...
//Heli Para Drop
[[(_position select 0),(_position select 1),0],[0,0,0],400,"BAF_Merlin_HC3_D",10,1,"Random",4,"Random","USMC_LHD_Crew_Blue","Random",False] spawn heli_para;
